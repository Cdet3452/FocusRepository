...
-- ─────────────────────────────────────────────────────────────────────────────
-- ✨ CARD BUILDER (Mobile Overlap Fixes)
-- ─────────────────────────────────────────────────────────────────────────────
local function BuildCard(parent, upgradeId, cfg, isEpic, cardRefsTable)
	...
	nameLabel.Size              = UDim2.new(0.6, -20, 0, 24)
	...
	descLabel.Size              = UDim2.new(0.6, -20, 0, 36)
	...
	levelLabel.Size             = UDim2.new(0.6, -20, 0, 18)
...
local function OpenShop()
	...
	TweenService:Create(ShopPanel, TweenInfo.new(0.35, Enum.EasingStyle.Back, Enum.EasingDirection.Out), { Position = UDim2.new(0, 90, 0.5, 0) }):Play()
