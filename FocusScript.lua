...
AreaRegistry.Areas = {
	[1] = { 
		...
		flipbookFrameH   = 128, 
		flipbookColumns  = 3,
		-- ✨ Notice how these exactly match the names in your Area1 > Auras folder!
		auraModels       = { Common = "GearAura", Uncommon = "ScrewAura", Rare = "TinCan", Epic = "OldTire", Legendary = "IntactRadio" }
	},
	[2] = { 
